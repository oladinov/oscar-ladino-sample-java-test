...
public class TransactionController {
    ...
    public Transaction addTransaction(@ApiParam(value = "The transaction's information") @RequestBody TransactionRequest request,
                                      @ApiParam(value = "The transaction's user") @PathVariable Integer userId) {
        Transaction transaction = Transaction.builder().amount(request.getAmount()).date(request.getDate())
    ...
    @ApiOperation(value = "Gets a transaction from DB",
            ...
            response = Transaction.class)
    public Transaction showTransaction(@ApiParam(value = "The transaction's user") @PathVariable Integer userId,
    ...
    public List<Transaction> listOfTransactions(@ApiParam(value = "The transaction's user") @PathVariable Integer userId) {
    ...
    public TransactionSum sumOfTransactions(@ApiParam(value = "The transaction's user") @PathVariable Integer userId) {
    ...
    public List<TransactionWeekReport> transactionsReport(@ApiParam(value = "The transaction's user") @PathVariable Integer userId) {
